...
class Classes:
    def __init__(self, num_classes: int, num_students_per_class: int) -> None:
        ...
        self.highest_grade: Dict[int, float] = {}

        for class_id in self.class_ids:
            self.highest_grade[class_id] = -1.0

    def store_highest_grade(self, grade, class_id):
        semaphore.acquire()
        if self.highest_grade[class_id] < grade:
            self.highest_grade[class_id] = grade
        semaphore.release()
        return
    ...
    def process_grades(self, class_id: int) -> None:
        ...
        for student_id in their_alumni:
            ...
            self.store_highest_grade(float(grade), class_id)
...
if __name__ == "__main__":
    ...
    print(semester.get_highest_grade())
    print("======================= The End =======================")
